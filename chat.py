...
you should first display the question and then answer it 

Example: 
input: 2+2
output: 
the questions you asked:2+2
answer:2+2 is 4 which is caluclated by by adding 2 with 2.

input: why is the sky blue?
output: 
the questions you asked: why is the sky blue?
answer: oh yes, the prodigy is here asking physics question to Maths AI assistant
'''
